...
VALUES
    ...
    ('Eternal Sunshine of the Spotless Mind','When their relationship...',108,'2004-01-01','R'),
    ('Pleasantville','Two 1990s teenage...',102,'1998-01-01','PG-13'),
    ('Back to the Future','Marty McFly, a 17-year...',116,'1985-01-01','PG'),
    ('Toy Story 3','The toys are mistakenly...',103,'2010-01-01','G'),
    ('This Film Is Not Yet Rated','Kirby Dicks expose about...',98,'2006-01-01','NC-17'),
    ('Ghostbusters','Three parapsychologists...',105, '1984-01-01','G')
;
